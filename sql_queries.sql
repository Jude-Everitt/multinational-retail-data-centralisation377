...
-- total sale as the sum of number of products times price for products. 
-- find highest total sale month for each year
...
-- count total staff for each store sum for total stores in country, 
...
-- sum total sales for each store
-- filterr forr country code
-- aggregaate by store type in country codee
...
-- Task 9: How quickly is store making sales
-- format time stamps of each sale
-- arrange sale data in chronological order of sales
-- obtain time between each sale and average for the year
-- group by year 
